...
int main(int argc, char **argv){
    ...
    position pos1 = {0,24.6,5,false};
    position pos2 = {3,15.1,5,false};
    position pos3 = {13,15.1,5,false};
    position pos4 = {4.9,9.4,5,false};
    position pos5  = {8.1,0,5,false};
    position pos6  = {0,5.8,5,false};
    position pos7 = {-8.1,0,5,false};
    position pos8 = {-4.9,9.4,5,false};
    position pos9 = {-13,15.1,5,false};
    position pos10 = {-3,15.1,5,false};

    position positions[11] = {pos1,pos2,pos3,pos4,pos5,pos6,pos7,pos8,pos9,pos10,pos1};
    //ROS_INFO
    ...
    while(ros::ok()){
        position pos;
        int make_it_smaller = 4;
        ros::Rate rate(0.3*make_it_smaller/2);
        rate.sleep();
        
        for(int i = 0; i < 11; ++i){

            pos.x = positions[i].x/make_it_smaller;
            pos.y = positions[i].y/make_it_smaller;
            pos.z = positions[i].z;
