...
int main(int argc, char **argv){
    ...
    float side_length = 5;
    position pos1 = {side_length,0,5,false};
    position pos2 = {side_length,side_length,5,false};
    position pos3 = {0,side_length,5,false};
    position pos4 = {0,0,5,false};

    position positions[4] = {pos1,pos2,pos3,pos4};
